...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
    {
        ...
        //tBackground.transform = CGAffineTransformMakeRotation(M_PI * (90.0 / 180.0));
        ...
        //self.textLabel.transform = CGAffineTransformMakeRotation(M_PI * (90.0 / 180.0));
        //self.detailLabel.transform = CGAffineTransformMakeRotation(M_PI * (90.0 / 180.0));
...
- (void)animateIn
{
    ...
    //CGRect frame = kGKAchievementFrameEnd;    
    //frame.origin = GLToUI(self.frame.origin.x, self.frame.origin.y);
    //self.frame = frame;
